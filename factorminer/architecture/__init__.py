...
_ATTRIBUTE_MAP = {
    ...
    "TrialLedger": ("factorminer.architecture.trial_ledger", "TrialLedger"),
    "TrialObservation": ("factorminer.architecture.trial_ledger", "TrialObservation"),
    "canonical_formula_identity": (
        "factorminer.architecture.trial_ledger",
        "canonical_formula_identity",
    ),
    "dataset_scope_identity": (
        "factorminer.architecture.trial_ledger",
