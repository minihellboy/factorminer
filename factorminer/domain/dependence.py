"""Domain-level dependence metrics for redundancy and replacement decisions.

This module deliberately depends only on numerical libraries.  It is shared by
the factor domain model, evaluation services, and higher-level orchestration;
none of those layers are imported back into this module.
"""
